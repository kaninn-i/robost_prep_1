...
class Path(Enum):
    ...
    CURRENT_TOOL_POSE = 'root/Control/manipulatorToolPoseActual'
    CURRENT_JOINT_POSE_RADIANS = 'root/AxesControl/axesPositionsActual'
    HOSTIN_JOINT_VELOCITY = 'root/Control/hostInJointVelocity'
    HOSTIN_TOOL_VELOCITY = 'root/Control/hostInToolVelocity'
    ACTIVATE_MOVE_TO_START = 'root/Control/activateMoveToStart'
    # TOOL_CMD = 'root/UserParameters/IO/Gripper'
    STATE_CMD = 'root/MotionInterpreter/actualStateOut'
    MANIPULABILITY_CMD = 'root/Control/manipulabilityDetector/input'
